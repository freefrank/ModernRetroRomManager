...
//!
//! 将用户的 ROM 目录名称映射到：
//! - CSV 数据库文件名 (rom-name-cn)
//! - jy6d CSV 数据库文件名 (emu.jy6d.com)
//! - Logo 图片文件名
...
pub struct SystemMapping {
    ...
    /// rom-name-cn CSV 数据库文件名（不含路径）
    pub csv_name: Option<&'static str>,
    /// jy6d-dz CSV 数据库文件名（不含路径，位于 resources/cn-mapping/）
    pub jy6d_csv_name: Option<&'static str>,
    /// Logo 图片文件名（不含路径）
...
pub fn get_system_mappings() -> Vec<SystemMapping> {
    vec![
        ...
        SystemMapping {
            folder_name: "PCE-CD",
            csv_name: Some("NEC - PC Engine - TurboGrafx-16.csv"),
            jy6d_csv_name: Some("pcecd.csv"),
            logo_name: Some("PCE-CD.png"),
        },
        SystemMapping {
            folder_name: "PC-FX",
            csv_name: Some("NEC - PC-FX.csv"),
            jy6d_csv_name: Some("pcfx.csv"),
        ...
        SystemMapping {
            ...
            csv_name: None,
            jy6d_csv_name: None,
            logo_name: Some("动作街机.png"),
        },
        SystemMapping {
            folder_name: "FBNEO STG",
            csv_name: None,
            jy6d_csv_name: None,
            logo_name: Some("射击街机.png"),
        },
        SystemMapping {
            folder_name: "FBNEO FTG",
            csv_name: None,
            jy6d_csv_name: None,
            logo_name: Some("对战街机.png"),
        },
        SystemMapping {
            folder_name: "FBNEO FLY",
            csv_name: None,
            jy6d_csv_name: None,
            logo_name: Some("飞机街机.png"),
        },
        SystemMapping {
            folder_name: "FBNEO RAC",
            csv_name: None,
            jy6d_csv_name: None,
            logo_name: Some("赛车街机.png"),
        },
        SystemMapping {
            folder_name: "FBNEO SPO",
            csv_name: None,
            jy6d_csv_name: None,
            logo_name: Some("运动街机.png"),
        },
        SystemMapping {
            folder_name: "FBNEO ETC",
            csv_name: None,
            jy6d_csv_name: None,
            logo_name: Some("休闲街机.png"),
        },
        // MAME 街机分类
        SystemMapping {
